    ...
    if(isset($_POST['id_pelanggan'])) {
        ...
        foreach($produk as $key => $val) {
            ...
            if($val > 0) {
                ...
                $update_produk = mysqli_query($koneksi, "UPDATE produk SET stok=stok-$val WHERE id_produk=$key");
            }
                            ...
                            <form method="POST">
                                <table class="table table-bordered">
                                    ...
                                    <tr>
                                        ...
                                        <td>:</td>
                                        <td><input class="form-control" name="produk[<?php echo $produk['id_produk']; ?>]" type="number" value="0" max="<?php echo $produk['stok'] ?>" step="0"></input>
                                        </td>
                                    </tr>
                                    <?php
                                        }
